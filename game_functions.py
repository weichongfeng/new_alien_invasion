...
def update_screen(ai_setting, screen, stats, sb, ship, aliens, bullets, play_button, background, alien_bullets):
    """更新屏幕上的图像,并切换到新屏幕"""
    # 每次循环时重新绘制屏幕
...
def update_alien_bullets(ai_settings, stats, sb, screen, ship, aliens, bullets, alien_bullets):
